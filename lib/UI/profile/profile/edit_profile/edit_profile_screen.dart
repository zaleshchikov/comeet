                                          ...
                                          if (form.valid) {
                                            BlocProvider.of<ProfileBloc>(context).add(
                                                UpdateProfile(
                                                    ...
                                                    form.control('profession').value,
                                                    form.control('description').value,
                                                    widget.profile.photo == "" && imageBytes == null ? '' : imageBytes == null ? widget.profile.photo : base64Encode(imageBytes)));
                                          } else {
