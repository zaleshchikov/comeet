...
class ChevronTop extends CustomClipper<Path> {
  ...
  getClip(Size size) {
    ...
    var endPoint = Offset(size.width * 0.5, size.height * 0.75);

    var controlPoint12 = Offset(size.width * 0.5, size.height * 0.75);
    var controlPoint22 = Offset(size.width * 0.6, size.height*0.65);
    var endPoint2 = Offset(size.width*0.7, size.height * 0.75);

    var controlPoint13 = Offset(size.width * 0.7, size.height * 0.75);
    var controlPoint23 = Offset(size.width * 0.85, size.height * 0.9);
