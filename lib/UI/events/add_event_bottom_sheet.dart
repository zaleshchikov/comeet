...
class _AddEventBottomSheetState extends State<AddEventBottomSheet> {
  var imageBytes;
  Event event = Event(
      '', '', DateTime.now(), DateTime.now(), true, [], '', getRandomColor());
                    ...
                    child: Column(
                      children: [
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                                ...
                                image: DecorationImage(
                                    image: imageBytes == null ? AssetImage('assets/icons/add_event.png') : MemoryImage(Uint8List.fromList(imageBytes)),
                                    fit: BoxFit.cover)),
                          ),
                        ),
                        Container(
                          ...
                          child: Container(
                            ...
                            child: GridView(
                                ...
                                children: List<Widget>.generate(
                                    ...
                                    (int index) => InkWell(
                                          onTap: () {
                                            event.dateStart = event.dateStart
                        ...
                        Container(
                          ...
                          child: ReactiveTextField(
                            onChanged: (_){
                              event.description = form.control('description').value ?? '';
                            },
                            style: theme.textTheme.bodySmall,
                            cursorColor: theme.textTheme.bodySmall!.color,
                            decoration: InputDecoration(
