                                      ...
                                      : Container(
                                          ...
                                          decoration: BoxDecoration(
                                              ...
                                              image: DecorationImage(
                                                  ...
                                                  CacheMemoryImageProvider(rng.nextInt(100000000).toString(),
                                                      base64Decode(state
                                                          .events[index]
                                                          .photo)),
                                                  fit: BoxFit.cover)),
                                        ),
                                  Text(DateFormat("dd.MM.yyyy").format(state.events[index].dateStart), style: theme.textTheme.labelLarge,)
                                ],
                              ),
                              Container(
                                width: size.width / 3,
